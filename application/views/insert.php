	            ...
	            <div class="paywall__auth__col paywall__auth__col_right">
	                <div class="paywall__auth__block">
	                    <div class="paywall__auth__main js-paywall-auth-main">
	                        <div class="paywall__auth__title"><h2>Insert New Flight</h2></div>
                                ...
                                <div class="paywall__auth__form__row"><h3>Departure City</h3>
                                    ...
                                    <div class="paywall__auth__form__row"><h3>Departure Time</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="time" name="time" placeholder="Enter Departure Time" required>
                                            </div>
                                    </div>
									<div class="paywall__auth__form__row"><h3>Arrival Time</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="time" name="artime" placeholder="Enter Arrival Time" required>
                                            </div>
                                    </div>
                                    <div class="paywall__auth__form__row"><h3>Flight Price</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="number" name="price" placeholder="Enter Price" required >
                                            </div>
                                    </div>
            </div>
                                    <div class="submit_form">
	                                    <div class="paywall__auth__form__submit-wrap"><br>
	                                        <input class="paywall__auth__form__submit" text-align="centered" class="button" name="submit" type="submit" value="Insert" >
                                        </div>
                                    </div>
