...
<body class="pic">
	...
	<div class="paywall g-paywall-layout">
	            ...
	            <div class="paywall__auth__col paywall__auth__col_right">
	                <div class="paywall__auth__block">
	                    <div class="paywall__auth__main js-paywall-auth-main">
	                        <div class="paywall__auth__title"><h2>Edit Flight Details</h2></div>
        ...
        <input name="fid" type="hidden" value="<?php echo $data[0]->fid;?>" />
                                <div class="paywall__auth__form__row"><h4>Departure City</h4>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="text" name="city_from" placeholder="Enter Departure City" required value="<?php echo $data[0]->city_from;?>">
                                            </div>
                                    </div>
                                    <div class="paywall__auth__form__row"><h4>Arrival City</h4>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="text" name="city_to" placeholder="Enter Arrival City" required value="<?php echo $data[0]->city_to;?>" >
                                            </div>
                                    </div>
                                    <div class="paywall__auth__form__row"><h4>Departure Time</h4>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="time" name="time" placeholder="Enter Departure Time" required value="<?php echo $data[0]->time;?>">
                                            </div>
                                    </div>
									<div class="paywall__auth__form__row"><h4>Arrival Time</h4>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="time" name="artime" placeholder="Enter Arrival Time" required value="<?php echo $data[0]->artime;?>">
                                            </div>
                                    </div>
                                    <div class="paywall__auth__form__row"><h4>Flight Price</h4>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input"type="number" name="price" placeholder="Enter Price" required value="<?php echo $data[0]->price;?>" >
                                            </div>
                                    </div>
            </div>
                                    <div class="submit_form">
	                                    <div class="paywall__auth__form__submit-wrap"><br>
	                                        <input class="paywall__auth__form__submit" text-align="centered" class="button" name="submit" type="submit" value="Update" >
                                        </div>
                                    </div>
