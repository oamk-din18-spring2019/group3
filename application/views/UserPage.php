...
<body class="pic">
	...
	<div class="paywall g-paywall-layout">
	            ...
	            <div class="paywall__auth__col paywall__auth__col_right">
	                <div class="paywall__auth__block">
	                    <div class="paywall__auth__main js-paywall-auth-main">
	                        <div class="paywall__auth__title"><h2>User Account Page</h2></div>
        ...
        echo '<centered> <h4> First Name : '. $result[0]['FNAME'] .'</h4></centered>';
        echo '<centered> <h4> Last Name  : '. $result[0]['LNAME'].'</h4></centered>' ;
