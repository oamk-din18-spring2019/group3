	            ...
	            <div class="paywall__auth__col paywall__auth__col_right">
	                <div class="paywall__auth__block">
	                    <div class="paywall__auth__main js-paywall-auth-main">
	                        <div class="paywall__auth__title">Login to get started.</div>
	                            <div class="paywall__auth__tab-content active js-paywall-tab-content">
	                            <div class="paywall__auth__form-wrap">
	                                <?php echo form_open('user_authentication/user_login_process'); ?>
	                                    <div class="paywall__auth__form__row"><h3>Email Address</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="text" name="Email" value="" required="" autocapitalize="off" autocomplete="off" placeholder="E-mail">
	                                        </div>
	                                    </div>
	                                    <div class="paywall__auth__form__row"><h3>Password</h3>
	                                        <div class="paywall__auth__form__input-wrap">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="password" name="password" value="" required="" autocapitalize="off" autocomplete="new-password" placeholder="Password">
	                                        </div>
	                                    </div>
