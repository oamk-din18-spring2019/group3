	            ...
	            <div class="paywall__auth__col paywall__auth__col_right">
	                <div class="paywall__auth__block">
	                    <div class="paywall__auth__main js-paywall-auth-main">
	                        <div class="paywall__auth__title"><h2>Login to get started</h2></div>
	                                ...
	                                <?php echo form_open('Login/user_login_process'); ?>
	                                    <div class="paywall__auth__form__row"><h3>Email Address</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="text" name="Email" value="" required="yes" autocapitalize="off" autocomplete="off" placeholder="E-mail" method="post" >
	                                        </div>
	                                    </div>
	                                    <div class="paywall__auth__form__row"><h3>Password</h3>
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                           <input class="paywall__auth__form__input js-paywall-auth-input" type="password" name="Password" value="" required="yes" autocapitalize="off" autocomplete="new-password" placeholder="Password" method="post" >
	                                        </div>
										</div>
										</div>
