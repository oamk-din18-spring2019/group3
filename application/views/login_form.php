	                        ...
	                        <div class="paywall__auth__title">Login to get started.</div>
	                            ...
	                            <div class="paywall__auth__form-wrap">
	                                <?php echo form_open('user_authentication/user_login_process'); ?>
	                                    <div class="paywall__auth__form__row">
	                                        <div class="paywall__auth__form__input-wrap paywall__auth__form__input-wrap_radius">
	                                            <input class="paywall__auth__form__input js-paywall-auth-input" type="text" name="username" value="" required="" autocapitalize="off" autocomplete="off" placeholder="E-mail">
	                                        </div>
	                                    </div>
	                                    <div class="paywall__auth__form__row">
	                                    ...
	                                    <div class="paywall__auth__form__submit-wrap">
